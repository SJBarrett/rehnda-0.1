...
namespace Rehnda {
    VkManager::VkManager(GLFWwindow *window) {
        ...
        swapchainManager = std::make_unique<SwapchainManager>(window, physicalDevice, &device, surface);
        initCommandPool();
        commandBuffer = createCommandBuffer();
        graphicsPipeline = std::make_unique<GraphicsPipeline>(&device, swapchainManager.get());
        createSyncObjects();
    }
    ...
    void VkManager::initCommandPool() {
        QueueFamilyIndices queueFamilyIndices = findQueueFamilies(physicalDevice, surface);
    ...
    void VkManager::createSyncObjects() {
    ...
    vk::CommandBuffer VkManager::createCommandBuffer() {
    ...
    void VkManager::waitForDeviceIdle() {
        device.waitIdle();
    }
}